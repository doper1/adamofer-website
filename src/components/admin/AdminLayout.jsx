  ...
  return (
    <div className="bg-[#030014] min-h-screen text-white flex flex-col font-sans">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar */}
        <aside className="w-56 border-r border-white/10 bg-black/20 flex flex-col p-4 overflow-y-auto">
        ...
        {/* Main Content */}
        <main className="flex-1 overflow-y-auto p-8 bg-gradient-to-br from-transparent to-purple-950/10">
