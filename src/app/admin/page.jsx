      ...
      {currentTab === "stats" && (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl">
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 md:p-8 flex flex-col items-center justify-center">
              <span className="text-4xl md:text-5xl font-extrabold text-purple-400 mb-2">{stats.totalVisits}</span>
              <span className="text-gray-500 text-sm md:text-base font-medium">Total Visits</span>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-2xl p-4 md:p-8 flex flex-col items-center justify-center">
              <span className="text-4xl md:text-5xl font-extrabold text-purple-400 mb-2">{stats.uniqueVisitors}</span>
              <span className="text-gray-500 text-sm md:text-base font-medium">Unique Visitors</span>
            </div>
          </div>
          <div className="p-4 md:p-8 bg-white/5 border border-white/10 rounded-2xl">
            <p className="text-gray-400 text-xs md:text-sm mb-6">Daily Visits (last 14 days)</p>
            <div className="w-full h-40 flex items-end justify-between border-b border-white/10 pb-4 gap-1 md:gap-2">
